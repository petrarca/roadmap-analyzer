...
# Page configuration
st.set_page_config(
    page_title="Project Roadmap Monte Carlo Analysis",
    page_icon="📊",
    layout="wide"
)
...
start_date = st.sidebar.date_input(
    "Project Start Date",
    value=datetime(2025, 7, 24),
    help="When the projects will begin"
)
...
def create_gantt_chart(stats, start_date, df):
    ...
    fig.update_layout(
        ...
        xaxis_title="Date",
        yaxis=dict(
            ticktext=[p[0] for p in sorted_projects],
...
def create_probability_chart(stats):
    ...
    fig.update_layout(
        title="On-Time Delivery Probability by Project",
        xaxis_title="Project",
