...
def test_simulation_with_variable_capacity(app_config, work_items):
    ...
    with patch("roadmap_analyzer.simulation.triangular_random", side_effect=lambda min_val, mode_val, max_val: mode_val):
        ...
        results_variable = simulation_engine.run_monte_carlo_simulation(
            work_items, default_capacity, start_date, num_simulations
        )
        ...
        # Run simulation with default capacity
        results_default = default_simulation_engine.run_monte_carlo_simulation(
            work_items, default_capacity, start_date, num_simulations
        )
...
def test_simulation_with_monthly_capacity(app_config, work_items):
    ...
    with patch("roadmap_analyzer.simulation.triangular_random", side_effect=lambda min_val, mode_val, max_val: mode_val):
        ...
        results = simulation_engine.run_monte_carlo_simulation(
            work_items, default_monthly_capacity, start_date, num_simulations
        )
